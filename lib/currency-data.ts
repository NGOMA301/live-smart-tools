...
export const currencies: Currency[] = [
  ...
  { code: "IMP", name: "Manx Pound", symbol: "£", country: "Isle of Man" },
  ...
  { code: "JEP", name: "Jersey Pound", symbol: "£", country: "Jersey" },
  ...
  { code: "SLL", name: "Sierra Leonean Leone (Old)", symbol: "Le", country: "Sierra Leone" },
  ...
  { code: "XAF", name: "Central African CFA Franc", symbol: "Fr", country: "Central African States" },
  ...
  { code: "XOF", name: "West African CFA Franc", symbol: "Fr", country: "West African States" },
  { code: "XPF", name: "CFP Franc", symbol: "Fr", country: "French Pacific Territories" },
